...
def main(args, parser):
    ...
    if args.opt == "adamw":
        ...
        opt = GenTwoPlaneMoMo(
            group_specs,
            lr=args.lr,
            beta_short=args.g_tp_momo_beta_short,
            beta_long=args.g_tp_momo_beta_long,
            beta_long_start=args.g_tp_momo_beta_long_start,
            beta_long_warmup_steps=args.g_tp_momo_beta_long_warmup_steps,
            eps=args.g_tp_momo_eps,
            clip_alpha=args.g_tp_momo_clip_alpha,
            use_loss_ema=args.g_tp_momo_use_loss_ema,
            alpha_denom_correction=args.g_tp_momo_alpha_denom_correction,
            preconditioner=args.g_tp_momo_preconditioner,
            precond_beta2=args.g_tp_momo_precond_beta2,
            weight_decay_factor=args.g_tp_momo_weight_decay_factor,
...
def get_exp_name(
    ...
    ignore_args=[
        ...
        "adema_beta3_warmup",
        "adema_alpha_warmup",
        "g_tp_momo_beta_short", 
        "g_tp_momo_beta_long", 
        "g_tp_momo_eps", 
        "g_tp_momo_clip_alpha", 
        "g_tp_momo_use_loss_ema",
        "g_tp_momo_preconditioner", 
        "g_tp_momo_precond_beta2", 
        "g_tp_momo_weight_decay_factor", 
